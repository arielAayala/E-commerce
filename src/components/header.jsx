                     ...
                     !user ? (
                        ...
                        <div className="text-end">
                           ...
                           <li className="nav-item text-end">
                              <a className="nav-link" aria-current="page" href="/cart"> Carrito <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cart" viewBox="0 0 16 16">
